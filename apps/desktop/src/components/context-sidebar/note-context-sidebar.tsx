...
/**
 * An ordinary note's contextual sidebar: note actions and its published-URL
 * status. Inbound links live under the note itself (the incoming-backlinks
 * panel), not here. Rendered in the AppShell's right region on `note` routes.
 */
